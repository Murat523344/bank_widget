...
Он позволяет фильтровать транзакции по валюте, получать их описания и генерировать номера карт.

---

### 1. filter_by_currency

Функция-фильтр, возвращает **генератор транзакций** с указанным кодом валюты.
...
# Выводим первые две транзакции в USD
for _ in range(2):
